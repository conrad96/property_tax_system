                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?php echo !empty($this->session->names)? $this->session->names : ""; ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?php echo !empty($this->session->names)? $this->session->names : ""; ?></a>
                                                    </h5>
                                                    <span class="email"><?php echo !empty($this->session->email)? $this->session->email : ""; ?></span>
                                                </div>
                                            </div>
                        ...
                        if(isset($msg) && !empty($msg)): 
                            ...
                            if($msg === TRUE): 
                             ...
                             print '<div class="alert alert-success">
                                    <h5>Debt Collector Added Successfully</h4>
                                  </div>';
                            
                            elseif($msg === 'password_mismatch'):

                            	print '<div class="alert alert-danger">
                                    <h5>Error!. Passwords Dont Match .please try again</h4>
                                </div>';

                            elseif($msg === FALSE):

                                print '<div class="alert alert-danger">
                                    <h5>Error!. Debt Collector Not Added.</h4>
                                </div>';
